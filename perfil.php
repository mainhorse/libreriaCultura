    ...
    <body>
        ...
        <div id="contNav">
        	...
        	<div id="segNav">
        		...
        		<div id="pedidos">
        			<img src="files/compras.png" width="70%" alt="carrito_compras">
        		</div>	
                ...
                echo "<script>
                        ...
                        if(cantidad == null){
                            ...
                            do{
                                ...
                                comprar.setAttribute('name','Comprar');
                                comprar.setAttribute('class','botVenta');
       ...
       <script src="js/javaScriptPerfil.js"></script>          
       </footer>  
       </html>